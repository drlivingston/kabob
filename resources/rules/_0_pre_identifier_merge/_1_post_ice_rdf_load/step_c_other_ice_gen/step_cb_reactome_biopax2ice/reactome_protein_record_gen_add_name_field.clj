`{:name "step-cb_reactome-protein-record-gen_add-name-field-value"
  ...
  :reify ([?/name_field {:ln (:sha-1 "Reactome protein record name field" ?/name)
                         :ns "kice" :prefix "F_"}])
