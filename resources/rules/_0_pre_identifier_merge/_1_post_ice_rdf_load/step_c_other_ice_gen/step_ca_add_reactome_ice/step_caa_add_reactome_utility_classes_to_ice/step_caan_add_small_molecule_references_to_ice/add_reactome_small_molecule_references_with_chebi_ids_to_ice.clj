`{:description "This rule finds any small molecule reference record described in Reactome with a ChEBI ID.",
...
SELECT ?smmol_ref ?xref_record ?xref_id_field ?chebi_ice WHERE {
