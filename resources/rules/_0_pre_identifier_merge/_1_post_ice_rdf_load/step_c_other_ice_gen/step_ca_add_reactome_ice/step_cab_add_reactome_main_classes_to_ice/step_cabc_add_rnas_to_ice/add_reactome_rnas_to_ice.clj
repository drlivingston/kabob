`{:description "This rule finds any RNA record described in Reactome, as well as its cellular location and its Reactome id field.",
 :name "add_reactome_rnas_to_ice",
 :reify ([?/rna_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome rna record" ?/rna), :prefix "R_"}]
         [?/reactome_ice]
         ),
 :head ((?/record_set obo/BFO_0000051 ?/rna_record)
        ...
        (?/rna_record obo/BFO_0000051 ?/cl_vocab_record)
        (?/cl_vocab_record rdf/type ccp/IAO_EXT_0001521) ;; cellular location field
        (?/rna ccp/ekws_temp_biopax_connector_relation ?/rna_record)
        ),
...
SELECT ?record_set ?rna ?xref_record ?xref_id_field ?reactome_ice ?cl_vocab_record WHERE {
