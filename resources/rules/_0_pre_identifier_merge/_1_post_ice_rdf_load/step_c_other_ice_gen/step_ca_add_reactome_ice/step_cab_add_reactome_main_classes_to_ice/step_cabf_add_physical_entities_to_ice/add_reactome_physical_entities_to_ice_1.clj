`{:description "This rule finds any physical entity record described in Reactome, as well as its cellular location and its Reactome id field.",
 ...
 :head ((?/record_set obo/BFO_0000051 ?/phent_record)
        (?/phent_record rdf/type ccp/IAO_EXT_0001515) ;; physical entity record
        ...
        (?/phent_record obo/BFO_0000051 ?/cl_vocab_record)
...
SELECT ?record_set ?phent ?xref_record ?xref_id_field ?reactome_ice ?cl_vocab_record WHERE {
