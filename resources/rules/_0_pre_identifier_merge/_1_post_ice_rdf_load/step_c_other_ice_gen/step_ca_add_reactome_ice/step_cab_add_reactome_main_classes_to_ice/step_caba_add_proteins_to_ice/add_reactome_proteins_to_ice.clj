`{:description "This rule finds any protein record described in Reactome, as well as its cellular location and its Reactome id field.",
 :name "add_reactome_proteins_to_ice",
 :reify ([?/prot_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome protein record" ?/prot), :prefix "R_"}]
         [?/reactome_ice]
         ),
 :head ((?/record_set obo/BFO_0000051 ?/prot_record)
        (?/prot_record rdf/type ccp/IAO_EXT_0001513) ;; protein record
        ...
        (?/prot_record obo/BFO_0000051 ?/cl_vocab_record)
        (?/cl_vocab_record rdf/type ccp/IAO_EXT_0001521) ;; cellular location field
        (?/prot ccp/ekws_temp_biopax_connector_relation ?/prot_record)
        ),
 :body "#add_reactome_proteins_to_ice.clj
...
SELECT ?record_set ?prot ?xref_record ?xref_id_field ?reactome_ice ?cl_vocab_record WHERE {
