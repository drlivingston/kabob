`{:description "This rule finds any small molecule record described in Reactome, as well as its cellular location and its Reactome id field.",
 :name "add_reactome_small_molecules_to_ice",
 :reify ([?/smmol_record {:ns "http://ccp.ucdenver.edu/kabob/ice/", :ln (:sha-1 "Reactome small molecule record" ?/smmol), :prefix "R_"}]
         [?/reactome_ice]
         ),
 :head ((?/record_set obo/BFO_0000051 ?/smmol_record)
        ...
        (?/smmol_record obo/BFO_0000051 ?/cl_vocab_record)
        (?/cl_vocab_record rdf/type ccp/IAO_EXT_0001521) ;; cellular location field
        (?/smmol ccp/ekws_temp_biopax_connector_relation ?/smmol_record)
        ),
 :body "#add_reactome_small_molecules_to_ice.clj
...
SELECT ?record_set ?smmol ?xref_record ?xref_id_field ?reactome_ice ?cl_vocab_record WHERE {
