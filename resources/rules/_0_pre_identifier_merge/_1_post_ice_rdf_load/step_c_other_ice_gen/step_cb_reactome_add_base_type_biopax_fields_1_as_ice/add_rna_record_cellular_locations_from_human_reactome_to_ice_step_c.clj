{:description "This rule finds any previously reified RNA record from Reactome and traces out its location via a unification xref to extract the RNA's cellular location (a Gene Ontology cellular compartment).",
 :name "add_rna_record_cellular_locations_from_human_reactome_to_ice_step_c",
 ...
 :head ((?/rna_record obo/BFO_0000051 ?/cellular_location_record)
 ...
 :sparql-string "#add_rna_record_cellular_locations_from_human_reactome_to_ice_step_c.clj
...
SELECT ?rna_record ?go_cc ?go_cc_id ?go_db ?go_cc_xref ?clean_go_cc_id
WHERE {
?rna rdf:type bp:Rna .
?rna bp:cellularLocation ?go_cc .
