{:description "This rule finds any previously reified protein record from Reactome and traces out any bits of the protein that have been cleaved (not its sequence modifications, which are described separately).",
 :name "add_protein_record_removed_fragment_features_from_human_reactome_to_ice_step_f1",
 ...
 :head ((?/prot_record obo/BFO_0000051 ?/fragment_feature_record)
 ...
 :sparql-string "#add_protein_record_removed_fragment_features_from_human_reactome_to_ice_step_f1.clj
...
SELECT ?prot_record ?site1 ?site2 ?pos_stat_1 ?pos_stat_2 ?start ?end ?frag_feature ?removed_chunk
WHERE {
