{:description "This rule finds any previously reified biochemical reaction record from Reactome and annotates its GO BP identifiers if they exist.",
 :name "add_biochemical_reaction_record_go_bp_ids_from_human_reactome_to_ice_step_d",
 ...
 :head ((?/bcr_record obo/BFO_0000051 ?/go_xref_record)
 ...
 :sparql-string "#add_biochemical_reaction_record_go_bp_ids_from_human_reactome_to_ice_step_d.clj
...
SELECT  ?bcr_record ?go_bp_id ?go_db_field ?go_id_field 
WHERE {
?bcr rdf:type bp:BiochemicalReaction .    # a biochemical reaction
?bcr bp:xref ?xref .       # with an xref 
