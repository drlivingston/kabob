{:description "This rule finds any previously reified DNA record from Reactome and traces out its location via a unification xref to extract the DNA's cellular location (a Gene Ontology cellular compartment).",
 :name "add_dna_record_cellular_locations_from_human_reactome_to_ice_step_c",
 ...
 :head ((?/dna_record obo/BFO_0000051 ?/cellular_location_record)
 ...
 :sparql-string "#add_dna_record_cellular_locations_from_human_reactome_to_ice_step_c.clj
PREFIX franzOption_chunkProcessingAllowed: <franz:yes>
PREFIX franzOption_clauseReorderer: <franz:identity>
PREFIX obo: <http://purl.obolibrary.org/obo/>PREFIX ccp: <http://ccp.ucdenver.edu/obo/ext/>
...
SELECT ?dna_record ?go_cc ?go_cc_id ?go_db ?go_cc_xref ?clean_go_cc_id 
WHERE {
?dna rdf:type bp:Dna .
?dna bp:cellularLocation ?go_cc .
