{:description "This rule finds any previously reified RNA record from Reactome and traces out its parent entity via a unification xref to extract the RNA's EMBL ID.",
 :name "add_rna_record_embl_ids_from_human_reactome_to_ice_step_d2",
 ...
 :head ((?/rna_record obo/BFO_0000051 ?/entity_record)
        ...
        (?/entity_xref_db_field rdfs/label "EMBL")
        ...
        (?/entity_xref_id_field rdf/type ccp/IAO_EXT_0001593)),
 :sparql-string "#add_rna_record_embl_ids_from_human_reactome_to_ice_step_d2.clj
