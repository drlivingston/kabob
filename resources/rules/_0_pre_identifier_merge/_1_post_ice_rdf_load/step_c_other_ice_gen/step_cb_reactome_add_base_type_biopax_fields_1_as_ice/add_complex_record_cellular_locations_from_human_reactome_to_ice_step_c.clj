{:description "This rule finds any previously reified complex record from Reactome and traces out its location via a unification xref to extract the complex's cellular location (a Gene Ontology cellular compartment).",
 :name "add_complex_record_cellular_locations_from_human_reactome_to_ice_step_c",
 ...
 :head ((?/compl_record obo/BFO_0000051 ?/cellular_location_record)
 ...
 :sparql-string "#add_complex_record_cellular_locations_from_human_reactome_to_ice_step_c.clj
...
SELECT ?compl_record ?go_cc_id ?go_db ?go_cc ?go_cc_xref ?clean_go_cc_id
WHERE {
?compl rdf:type bp:Complex .
?compl bp:cellularLocation ?go_cc .
