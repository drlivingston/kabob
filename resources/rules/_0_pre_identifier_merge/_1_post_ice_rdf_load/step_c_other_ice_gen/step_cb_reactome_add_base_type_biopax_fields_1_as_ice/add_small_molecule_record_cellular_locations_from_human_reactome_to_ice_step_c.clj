{:description "This rule finds any previously reified small molecule record from Reactome and traces out its location via a unification xref to extract the small molecule's cellular location (a Gene Ontology cellular compartment).",
 :name "add_small_molecule_record_cellular_locations_from_human_reactome_to_ice_step_c",
 ...
 :head ((?/smmol_record obo/BFO_0000051 ?/cellular_location_record)
 ...
 :sparql-string "#add_small_molecule_record_cellular_locations_from_human_reactome_to_ice_step_c.clj
...
SELECT ?smmol_record ?go_cc_id ?go_db ?go_cc ?go_cc_xref ?clean_go_cc_id 
WHERE {
?smmol rdf:type bp:SmallMolecule .
?smmol bp:cellularLocation ?go_cc .
