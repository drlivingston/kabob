...
;; --------------------------------------------------------------------
`{:name "step-ac_trans-identifier-typing"
  :description "This rule specifically the sequence ontology identifier"
  :head ((?/id rdfs/subClassOf ccp/IAO_EXT_0001849) ; CCP:pathogen_transmission_ontology_identifier
  ...
  prefix franzOption_clauseReorderer: <franz:identity>
                  ...
                  select distinct ?id {
                  ?c oboInOwl:hasOBONamespace 'transmission_process' .
