...
;; ------------------------------------------------------------------------
;; create id denotes concept triple for every ontology concept; this rule handles the PomBase URIs used by pr.owl
`{:name "ontology-id-denotes-concept-gen-pombase"
  ...
  :head ((?/id obo/IAO_0000219 ?/ontology_concept) ; denotes
         ...
         (?/id rdf/type ccp/IAO_EXT_0000336)) ; ccp:PomBase gene identifier
