...
;; ------------------------------------------------------
`{:name "protein-coding-gene-type-assertions"
  :description "This rule asserts protein coding gene type"
  :head ((?/gene rdfs/subClassOf obo/SO_0001217)) ; SO:protein_coding_gene
