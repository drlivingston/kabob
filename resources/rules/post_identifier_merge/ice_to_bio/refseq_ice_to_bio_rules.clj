...
;;TODO break up into smaller rules
;; `{:name "refseq-i2b0-kabobdna-partof-genomic-refseq-assertions"
;;   :head ((?/subSeqInstance obo/proper_part_of ?/refseqKabobDna)
...
;;   :body
;;   ((_/record kiao/hasTemplate iaoeg/EntrezGene2RefseqFileDataSchema1)
;;    ~@(kabob/rtv _/record
;;        iaoeg/EntrezGene2RefseqFileData_geneIDDataField1 _/egIce
;;        iaoeg/EntrezGene2RefseqFileData_genomic_nucleotide_accession_dot_versionDataField1 _/refseqIce
;;        iaoeg/EntrezGene2RefseqFileData_start_position_on_the_genomic_accessionDataField1 ?/startPosition
;;        iaoeg/EntrezGene2RefseqFileData_end_position_on_the_genomic_accessionDataField1   ?/endPosition)
...
;;             :ns "kbio" :prefix "DNASubSeq_" :suffix ""}])}
