;; ----------------------------------------------------------------------------------
;; --------- Gene Ontology Cellular Compartment Concept Assignment ---------
;; ----------------------------------------------------------------------------------
`{:name "goa-cellular-compartment-ice-to-bio"
  :description "This rule creates a subclass of every cellular compartment and types it as a gene ontology cellular compartment concept identifier (IAO_EXT_0000200)"
  :head (
  ...
  :body ((?/go_ice_id [rdfs/subClassOf *] ccp/IAO_EXT_0000200) ; ccp:Gene_Ontology_Concept_Identifier__GO_cellular_compartment_concept_identifier
         (?/go_ice_id obo/IAO_0000219 ?/go_cc) ; IAO:denotes
         ...
         ;; filter out the negations
          (:optional
           ((?/record obo/BFO_0000051 ?/qualifier_field_value) ; BFO:has_part
