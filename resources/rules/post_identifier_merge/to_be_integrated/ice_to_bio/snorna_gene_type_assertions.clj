;; ----------------------------------------------
;; --------- snoRNA Gene Type Assertion ---------
;; -----------------------------------------------
 `{:name "snoRNA-gene-type-assertion"
   :description "This rule asserts snoRNA gene type"
   :head ((?/gene rdfs/subClassOf obo/S0_0000275)) ; SO:snoRNA
