...
;; ------------------------------------------------------------------------
`{:name          "copy-owl-restriction-to-bio-pr-other"
  ...
  :sparql-string "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
                  ...
                  select distinct ?obo_restriction {
                    ?ccp_id rdfs:subClassOf* ccp:IAO_EXT_0000112 .
                    ...
                    minus { ?obo_restriction owl:onProperty <http://purl.obolibrary.org/obo/pr#has_gene_template>}
                    minus { ?obo_restriction owl:onProperty obo:RO_0002160}
                  }"
  }