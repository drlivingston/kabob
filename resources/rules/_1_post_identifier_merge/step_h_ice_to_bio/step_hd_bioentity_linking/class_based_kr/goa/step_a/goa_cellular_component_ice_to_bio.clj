...
;; -----------------------------------------------------------------------
`{:name "step-hda_goa-cellular-component-ice-to-bio"
  ...
  :head (
         ;; create a subclass of GO localization
          (?/localization_sc rdfs/subClassOf ccp/temp_localization_process)
...

  {
   select ?has_target_end_location {
                    ...
                    optional {?cellular_component rdfs:label ?ccl}
