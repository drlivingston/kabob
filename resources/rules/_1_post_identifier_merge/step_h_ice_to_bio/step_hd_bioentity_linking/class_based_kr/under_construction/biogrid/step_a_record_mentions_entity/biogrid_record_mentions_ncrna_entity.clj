;; ----------------------------------------------------------
;; --------- BioGRID record mentions ncRNA entity ---------
;; ----------------------------------------------------------
`{:name          "biogrid-record-mentions-ncrna-entity"
    ...
    select ?bioentity ?record {
      {
                         ...
                         }
       {
        ...
        filter not exists {?gene rdfs:subClassOf ?protein_coding_gene}
        ...
        ?bioentity rdfs:subClassOf* ?ncRNA .
        }"
