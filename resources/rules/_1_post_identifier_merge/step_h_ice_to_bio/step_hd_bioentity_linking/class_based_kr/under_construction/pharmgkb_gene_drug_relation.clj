;; -----------------------------------------------
;; --------- PharmGKB Gene Drug Relation ---------
;; -----------------------------------------------
`{:name "pharmgkb-gene-drug-relation"
  :description "This rule assigns relations between genes and drugs"
  :head (
  ...
  :body ((?/record rdf/type ccp/IAO_EXT_0000823) ; ccp:PharmGKB_relation_record
         ...
         ;; retrieve entity type data field 2 - drug
         ...
         (?/type_2_id obo/IAO_0000219 ?/drug_sc) ; IAO:denotes
         
         ;; retrieve entity data identifier field 2 - drug
         ...
         (?/identifier_2_ice_id obo/IAO_0000219 ?/drug_sc)) ; IAO:denotes
