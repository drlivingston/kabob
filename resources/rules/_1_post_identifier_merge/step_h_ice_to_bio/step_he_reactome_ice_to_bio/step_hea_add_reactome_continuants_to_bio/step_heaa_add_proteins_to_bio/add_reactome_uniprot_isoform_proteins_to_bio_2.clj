`{:description "This rule finds any Uniprot Isoform protein record described in Reactome with:
...
The rule generates the Reactome protein's ICE identifier and places the top-level entity on the BIO side as a localized subclass of the BIO entity denoted by the UniProt ICE id.",
 :name "add_reactome_uniprot_isoform_proteins_to_bio_2",
 ...
 :body "#add_reactome_uniprot_isoform_proteins_to_bio_2
