...
SELECT DISTINCT ?reactome_ice ?ncbi_nucleotide_ice ?accession_label ?transports_bio ?targets_bio ?localization_bio ?gocc_bio ?dna_record 
WHERE {
...
bind (uri (concat (str (\"http://purl.obolibrary.org/obo/NCBI_\"), str (?accession_label))) AS ?obo_ncbi_nucleotide) .
OPTIONAL {
?ncbi_nucleotide_ice obo:IAO_0000219 ?ncbi_nucleotide_bio .
