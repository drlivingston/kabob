...
SELECT DISTINCT ?reactome_ice ?ncbi_nucleotide_ice ?accession_label ?transports_bio ?targets_bio ?localization_bio ?gocc_bio ?rna_record 
WHERE {
...
?ncbi_nucleotide_field rdf:type ?ncbi_ice .
