...
##${BASE_SCRIPT_DIR}/RULES.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_aa_ontology_root_identifier_gen
#${BASE_SCRIPT_DIR}/LOAD.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_aa_ontology_root_identifier_gen
##${BASE_SCRIPT_DIR}/RULES.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_ab_ontology_id_denotes_concept
#${BASE_SCRIPT_DIR}/LOAD.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_ab_ontology_id_denotes_concept
