...
#${BASE_SCRIPT_DIR}/RULES.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/identifier_normalization
${BASE_SCRIPT_DIR}/LOAD.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/identifier_normalization
...
#${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hc_ggp_abstractions/step_hcc_assign_taxon/ncbi
${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hc_ggp_abstractions/step_hcc_assign_taxon/ncbi
#${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hc_ggp_abstractions/step_hcc_assign_taxon/refseq
${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hc_ggp_abstractions/step_hcc_assign_taxon/refseq
#${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hc_ggp_abstractions/step_hcc_assign_taxon/uniprot
${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hc_ggp_abstractions/step_hcc_assign_taxon/uniprot
...
#
##${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hd_bioentity_linking/class_based_kr/biogrid/step_a_record_mentions_entity
##${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hd_bioentity_linking/class_based_kr/biogrid/step_a_record_mentions_entity
#
###
${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hd_bioentity_linking/class_based_kr/bioplex
${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hd_bioentity_linking/class_based_kr/bioplex
#${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hd_bioentity_linking/instance_based_kr/bioplex
#${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_h_ice_to_bio/step_hd_bioentity_linking/instance_based_kr/bioplex
#
###
...
##
####### bioworld expansion
${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_i_bio_expansion/class_based_kr
${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_i_bio_expansion/class_based_kr
#${BASE_SCRIPT_DIR}/RULES.sh rules/post_identifier_merge/step_i_bio_expansion/instance_based_kr
#${BASE_SCRIPT_DIR}/LOAD.sh rules/post_identifier_merge/step_i_bio_expansion/instance_based_kr
#
