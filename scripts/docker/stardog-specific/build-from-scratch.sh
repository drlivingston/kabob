...
SCRIPT_DIR=/kabob.git/scripts/docker/stardog-specific

/kabob.git/scripts/docker/common-scripts/build-from-scratch.sh ${SCRIPT_DIR} $1 true

#chmod -R 755 ${SCRIPT_DIR}
#
## This script takes a single argument specifying the repository name to use/construct
#export KB_INSTANCE_NAME=$1
#export DOCKER_ENV=${SCRIPT_DIR}/docker-env.sh
#
#source ${DOCKER_ENV}
...
#${SCRIPT_DIR}/create-new-database-stardog.sh ${KB_NAME}
#
...
#${SCRIPT_DIR}/load-list-file-stardog.sh \
#  ${KB_PORT} \
#  ${KB_NAME} \
...
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_a_ontology_root_identifier_gen
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_a_ontology_root_identifier_gen
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_b_ontology_id_denotes_concept
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_b_ontology_id_denotes_concept
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_c_ontology_ice_record_gen
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_c_ontology_ice_record_gen
##
##### create skos:exactMatch links between equivalent ontology identifiers
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/chebi
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/chebi
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/equivalent_class
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/equivalent_class
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/shared_label
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/pre_ice_rdf_load/step_b_ontology_id_exact_match/shared_label
#
...
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/post_ice_rdf_load/step_a_ice_id_typing
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/post_ice_rdf_load/step_a_ice_id_typing
##${SCRIPT_DIR}/RULES-STARDOG.sh rules/pre_identifier_merge/post_ice_rdf_load/step_b_ice_id_exact_match/datasource_xref
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/pre_identifier_merge/post_ice_rdf_load/step_b_ice_id_exact_match/datasource_xref
...
##${SCRIPT_DIR}/LOAD-STARDOG.sh id_sets/exact
...
#${SCRIPT_DIR}/RULES-STARDOG.sh rules/post_identifier_merge/step_a_bioentity_generation
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/post_identifier_merge/step_a_bioentity_generation

#
## connect bioentities based on ontology hierarchies
#${SCRIPT_DIR}/RULES-STARDOG.sh rules/post_identifier_merge/step_b_ontology_to_bio/step_a
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/post_identifier_merge/step_b_ontology_to_bio/step_a
#${SCRIPT_DIR}/RULES-STARDOG.sh rules/post_identifier_merge/step_b_ontology_to_bio/step_b
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/post_identifier_merge/step_b_ontology_to_bio/step_b
#${SCRIPT_DIR}/RULES-STARDOG.sh rules/post_identifier_merge/step_b_ontology_to_bio/step_c
#${SCRIPT_DIR}/LOAD-STARDOG.sh rules/post_identifier_merge/step_b_ontology_to_bio/step_c
#
