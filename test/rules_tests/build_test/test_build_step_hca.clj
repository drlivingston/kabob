(ns rules-tests.build_test.test_build_step_hc_ggp_abstraction
  (use clojure.test
       kr.sesame.kb
       kr.sesame.sparql
       kr.sesame.rdf
...
(deftest step-hcb-missing-gene-gen
  (let [source-kb base-kb
    ...
    ; the following works, but we want to avoid modifying the source-kb b/c it can affect other tests
    ;(is (ask source-kb '(
