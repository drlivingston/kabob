(ns rules-tests.build_test.test_build_step_hc_reactome_biopax2ice
  (use clojure.test
       kr.sesame.kb
       kr.sesame.sparql
       kr.sesame.rdf
  ...
  (:require [kabob.build.run-rules :refer [query-variables run-forward-rule-sparql-string]]
            ...
            [rules-tests.build-test.test-build-util :refer [initial-plus-ice-triples run-build-rule run-build-rules
                                                            ...
                                                            build-rules-step-hc-reactome-biopax2ice-step-a
                                                            build-rules-step-hc-reactome-biopax2ice-step-b
                                                            build-rules-step-hc-reactome-biopax2ice-step-c
...
(deftest biopax2ice-step-a
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-a 0)
...
(deftest biopax2ice-step-b-add-cellular-location
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 0)
...
(deftest biopax2ice-step-b-add-display-name
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 1)
...
(deftest biopax2ice-step-b-add-located-modification-feature
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 2)
...
(deftest biopax2ice-step-b-add-member-physical-entity-reference-feature
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 3)
...
(deftest biopax2ice-step-b-add-name
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 4)
...
(deftest biopax2ice-step-b-add-removed-fragment-feature-reference-feature
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 5)
...
(deftest biopax2ice-step-b-add-uniprot-identifier-field
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 6)
...
(deftest biopax2ice-step-b-add-uniprot-isoform-identifier-field
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 7)
...
(deftest biopax2ice-step-b-add-unlocated-modification-feature
  (let [source-kb (test-kb initial-plus-ice-triples)
        target-kb (test-kb '())]
    (run-build-rules source-kb build-rules-step-hc-reactome-biopax2ice-step-a)
    (run-build-rule source-kb target-kb build-rules-step-hc-reactome-biopax2ice-step-b 8)
