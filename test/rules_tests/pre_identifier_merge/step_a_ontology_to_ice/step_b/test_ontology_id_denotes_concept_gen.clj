...
(deftest test-rule
  (let [
        ;rule1 (first (filter #(= (:name %) "ontology-id-denotes-concept-gen-obo")
        ;                    (kabob-load-rules-from-classpath "rules/pre_identifier_merge/pre_ice_rdf_load/step_a_ontology_to_ice/step_aa_ontology_id_denotes_concept_non_obo_ns")))
